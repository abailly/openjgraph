...
public class EulerCircleFinder {
   ...
   *         returned
   */
  private Edge findUnusedEdge (Object v, List usedEdges) {
  ...
  public static Path find (Graph g)  {
      ...
      try {
        List eulerCirlce = getSingletonInstance().findEulerCircle(getSingletonInstance().getGraph().getVerticesIterator().next());
        Path eulerPath = new PathImpl ();
        for (Iterator it = eulerCirlce.iterator();it.hasNext();) {
          try {
            eulerPath.add(it.next());
          } catch (Exception e) {
  ...
  private List findEulerCircle(Object startVertex) throws NoEulerCircleException {
    switch (getGraph().getVerticesCount()) {
      case 0 : throw new RuntimeException ("Error in finding algorithm"); // should not occur
      case 1 : return Arrays.asList(new Object[] { startVertex });
      default:
        Object currentVertex = startVertex;
        ...
        for (Iterator it = primaryCircle.iterator();it.hasNext();) {
          Object v = it.next();
          if (getGraph().getAllVertices().contains(v)) {
...
/*
  ...
  public static void main (String[] args) throws Exception {
    ...
    Object v1 = new VertexImpl ("1");
    Object v2 = new VertexImpl ("2");
    Object v3 = new VertexImpl ("3");
    Object v4 = new VertexImpl ("4");
    Object v5 = new VertexImpl ("5");
    Object v6 = new VertexImpl ("6");
    Object v7 = new VertexImpl ("7");
    Object v8 = new VertexImpl ("8");
