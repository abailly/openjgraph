...
/**
 * Implements a binary or between two graph filters
 * 
 * @author nono
 * @version $Id: OrGraphFilter.java 1268 2006-08-14 13:25:12Z nono $
 */
public class OrGraphFilter implements GraphFilter {

	private GraphFilter b;

	private GraphFilter a;

	public OrGraphFilter(GraphFilter a,GraphFilter b) {
		this.a = a;
		this.b = b;
	}
